            ...
            >
                ...
                <div className="flex items-center gap-3 border-b border-zinc-200/50 px-6 py-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-semibold text-zinc-400 uppercase tracking-wider">Shipper Portal</p>
                    </div>
                    <button
                        onClick={() => setSidebarOpen(false)}
                ...
                <div className="border-t border-zinc-200/50 px-4 py-4">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-bold text-zinc-800 truncate">{user?.fullName || "Shipper"}</p>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="flex h-16 items-center justify-between border-b border-zinc-200/50 bg-white px-4 shadow-sm lg:px-8">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-primary">{user?.fullName || "Shipper"}</span>
                    </div>
